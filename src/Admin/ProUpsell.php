...
final class ProUpsell
{
    ...
    {
        /**
         * Filters whether the Sizer PRO promo is shown on the settings screen.
         *
    ...
    private function priceLabel(): string
    {
        ...
        if ($this->isPolish() && ! empty($d['price_pln'])) {
            ...
            return sprintf(__('od %d zł/rok', 'plogins-sizer'), (int) $d['price_pln']);
        }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'plogins-sizer'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Sizer Pro');
        ...
        <div class="sizer-pro-banner" role="note">
            ...
            <p class="sizer-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'plogins-sizer'), esc_html($name)); ?></strong>
    ...
    public function cards(): void
    {
        ...
        <section class="sizer-pro-cards" aria-labelledby="sizer-pro-cards-h">
            <h2 id="sizer-pro-cards-h" class="sizer-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'plogins-sizer'), esc_html($name)); ?>
            </h2>
