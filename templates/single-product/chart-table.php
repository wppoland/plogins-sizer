...
if (empty($sizer_rows) || empty($sizer_columns)) :
    ?>
    <p class="sizer-chart__empty"><?php esc_html_e('No size information is available yet.', 'mezuro'); ?></p>
    <?php
    return;
endif;
...
<div class="sizer-chart__scroll">
    <table class="sizer-chart__table">
        <caption class="screen-reader-text">
            <?php echo '' !== $sizer_name ? esc_html($sizer_name) : esc_html__('Size chart', 'mezuro'); ?>
        </caption>
        <thead>
            <tr>
